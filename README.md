...
To perform the data preprocessing, run the script `clean_predictions.py` in the `lib` folder.  Navigate to `src/client` and run `python -m SimpleHTTPServer` to view our project.
