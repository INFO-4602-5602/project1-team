...
To perform the data preprocessing, run the script `clean_predictions.py` in the `lib` folder.  Navigate to `src` and run `python -m SimpleHTTPServer` then click `client` to view our project.
